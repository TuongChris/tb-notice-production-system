...
| Current mission | TB_R6_POST_MERGE_CLOSEOUT_AND_P3B_BRANCH — post-merge reconciliation, R6 closeout records and the P3B branch; no P3B implementation. Its final branch CI result is reported with the closeout |
...
| Not started | P3B implementation (its branch is prepared; see *Next phases*), Cases and every later phase — each needs explicit approval |
...
| Deployment | none |
| Latest CI-verified code commit | `main` after the P3A merge: `adea2bc5b7ab5ed4cbc9fb309055b6f930d64cce` (push run `35968171532`, both jobs success). Accepted P3A head: `c1b8d22cc748d1b0be10be0ecf4a5f464d2c396e` (push run `35966993063`, pull_request run `35966987256`, both success). P3A code: `85c2839` (push run `35966162924`). P2 R5 remediation: `4b67fff631fa8b51a243fbecd64d43f76ce79d97` (run `35953912083`). P2 at R5: `cbfd640` (run `35948987435`). P1.1: `8fe96ae` (run `35894704102`). P1: `5507726` (run `35885393358`). P0: `0dfc7a5` (run `35863416044`) |
...
| Phase | Scope | Gate |
|---|---|---|
| **P3B — Representation authority** | Mandate, MandateVersion, MandateCoverage, CoverageSigner, AuthorityEvent (proposed scope in `P3A_SOURCES_ROUTE.md` §18). Branch `feature/p3b-representation-authority` prepared from `main` `adea2bc`; implementation needs its own explicit, approved mission | R7 |
...
2. P3B: implementation needs its own explicit mission (the branch is prepared; nothing is implemented).
