...
//   later case phases (reported items) are not routed (404) → logout. No mandate, coverage, case,
//   signing or sending exists in this flow (the P3B authority flow is `yarn smoke:p3b`, the P4A
//   case flow `yarn smoke:p4a`).
