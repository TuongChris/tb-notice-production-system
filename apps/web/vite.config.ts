...
// The browser talks to one origin; CORS is disabled on the Vite servers too (API_CONTRACT_v1 §3
// "deny CORS"), so no Access-Control-Allow-* header is added to proxied API responses.
const apiProxy = {
  '/api': {
